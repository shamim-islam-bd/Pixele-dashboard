...
export default function Sidebar() {
  ...
  return (
    <div className="">
      <p className="logo text-white py-[18px] text-[21px]">SMK LTD.</p>
      <span className="flex gap-2 text-[14px] items-center my-3 global">
        {" "}
        <AiOutlineGlobal
          style={{
            fontSize: "14px",
          ...
          {ShipNames.map((item, index) => (
            <div>
              ...
              >
                ...
                >
                  <span className="namePlate flex gap-3 text-base justify-between items-center text-white">
                    <img
              ...
              <div className="flex flex-col gap-2 items-end data">
                {item.data.map((data, index) => (
                  <div className="rounded-full">
                    <div className="namePlate">
                      ...
                      <p className="text-sm">{data.media}</p>
                    </div>
                  </div>
                ))}
              </div>
